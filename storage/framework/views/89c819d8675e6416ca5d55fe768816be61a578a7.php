    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <!-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(route('admin.country.index')); ?>">Country</a></li>
                    <li><a href="<?php echo e(route('admin.city.index')); ?>">City</a></li>
                    <li><a href="<?php echo e(route('admin.district.index')); ?>">District</a></li>
                </ul>
            </li> -->
...
<?php /**PATH /home/hatem/Desktop/CMS(hatem)/resources/views/admin/layouts/sidebar/sidebar.blade.php ENDPATH**/ ?>